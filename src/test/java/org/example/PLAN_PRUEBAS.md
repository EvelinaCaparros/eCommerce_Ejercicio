...
- Intentar crear shampoo con nombre vacío o nulo (debe lanzar excepción).
...
### 7. Inyección de archivo para test
- Usar un archivo temporal para pruebas unitarias y verificar que no afecta datos reales.

---

## Datos de pruebas posibles
